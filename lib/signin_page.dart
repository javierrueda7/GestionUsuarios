...
import 'package:powerbicu/mainmenu.dart';
import 'package:powerbicu/newuser.dart';
import 'package:powerbicu/resetpassword.dart';
                              ...
                              if (userWithEmail != null &&
                                ...
                                FirebaseAuth.instance
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Bienvenid@ ${userWithEmail['name']}, inicio de sesión satisfactorio.', style: const TextStyle(color: Colors.black)),
                                      duration: const Duration(seconds: 4),
                                      backgroundColor: const Color.fromRGBO(52, 194, 64, 1),
                                    ),
                                  );
                                  Navigator.push(
                                      context,
        ...
        onTap: () {
          FirebaseAuth.instance.signInAnonymously().then((value) {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => const MainMenu(role: 'ANONIMO', uid: '')));
          // ignore: sdk_version_since
          }).onError((error, stackTrace) {});
        },
        child: Container(
